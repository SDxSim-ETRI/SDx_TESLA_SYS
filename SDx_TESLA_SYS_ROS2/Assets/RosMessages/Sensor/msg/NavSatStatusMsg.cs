...
namespace RosMessageTypes.Sensor
{
    ...
    public class NavSatStatusMsg : Message
    {
        ...
        public const sbyte STATUS_UNKNOWN = -2; //  status is not yet set
        ...
        public sbyte status = -2; //  STATUS_UNKNOWN
        //  Bits defining which Global Navigation Satellite System signals were
        //  used by the receiver.
        public const ushort SERVICE_UNKNOWN = 0; //  Remember service is a bitfield, so checking (service & SERVICE_UNKNOWN) will not work. Use == instead.
